...
module Bridgetown
  class Theme
    ...
    def initialize(name)
      ...
      Bridgetown.logger.debug "Theme:", name
      Bridgetown.logger.debug "Theme source:", root
    end

    def root
      # Must use File.realpath to resolve symlinks created by rbenv
      # Otherwise, Bridgetown.sanitized path with prepend the unresolved root
    ...
    def realpath_for(folder)
      ...
      Bridgetown.sanitized_path(root, File.realpath(Bridgetown.sanitized_path(root, folder.to_s)))
    ...
    def gemspec
      ...
      raise Bridgetown::Errors::MissingDependencyException,
