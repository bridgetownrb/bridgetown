...
module Bridgetown
  module Utils
    extend self
    autoload :Ansi, "bridgetown/utils/ansi"
    autoload :Exec, "bridgetown/utils/exec"
    autoload :Internet, "bridgetown/utils/internet"
    autoload :Platforms, "bridgetown/utils/platforms"
    autoload :ThreadEvent, "bridgetown/utils/thread_event"
