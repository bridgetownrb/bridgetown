  ...
  class ThemeBuilder
    ...
    def mkdir_p(directories)
      Array(directories).each do |directory|
        ...
        Bridgetown.logger.info "create", full_path.to_s
    ...
    def initialize_git_repo
      Bridgetown.logger.info "initialize", path.join(".git").to_s
    ...
    class ERBRenderer
      ...
      def bridgetown_version_with_minor
        Bridgetown::VERSION.split(".").take(2).join(".")
      end
