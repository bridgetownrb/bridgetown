Feature: Include tags
  ...
  Scenario: Include a file with parameters
    ...
    And I should see "<header>My awesome blog header: myparam</header>" in "output/2013/03/21/include-files.html"
    And I should not see "myparam" in "output/2013/03/21/ignore-params-if-unused.html"
    And I should see "<li>date = today</li>" in "output/2013/03/21/list-multiple-parameters.html"
    And I should see "<li>start = tomorrow</li>" in "output/2013/03/21/list-multiple-parameters.html"
    And I should not see "<header>My awesome blog header: myparam</header>" in "output/2013/03/21/dont-keep-parameters.html"
    But I should see "<header>My awesome blog header: </header>" in "output/2013/03/21/dont-keep-parameters.html"
    And I should see "<li>cool = param with spaces</li>" in "output/2013/04/07/allow-params-with-spaces-and-quotes.html"
    And I should see "<li>super = \"quoted\"</li>" in "output/2013/04/07/allow-params-with-spaces-and-quotes.html"
    And I should see "<li>single = has \"quotes\"</li>" in "output/2013/04/07/allow-params-with-spaces-and-quotes.html"
    And I should see "<li>escaped = 'single' quotes</li>" in "output/2013/04/07/allow-params-with-spaces-and-quotes.html"
    And I should see "<li>param1_or_2 = value</li>" in "output/2013/04/12/parameter-syntax.html"
    And I should see "<li>local = some text</li>" in "output/2013/06/22/pass-a-variable.html"
    And I should see "<li>title = Pass a variable</li>" in "output/2013/06/22/pass-a-variable.html"
  ...
  Scenario: Include a file from a variable
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "a snippet that works with parameters" in "output/index.html"
  ...
  Scenario: Include a variable file in a loop
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "one two" in "output/index.html"
  ...
  Scenario: Include a file with variables and filters
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "one included" in "output/index.html"
  ...
  Scenario: Include a file and rebuild when include content is changed
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "include" in "output/index.html"
    When I wait 1 second
    Then I have an "_includes/one.html" file that contains "include content changed"
    When I run bridgetown build
    Then I should see "include content changed" in "output/index.html"
