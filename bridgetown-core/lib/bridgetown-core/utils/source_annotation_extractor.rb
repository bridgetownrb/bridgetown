...
module Bridgetown
  module Utils
    # Implements the logic behind <tt>Bridgetown::Commands::Notes</tt>. See <tt>bin/bridgetown help notes</tt> for usage information.
    #
    ...
    class SourceAnnotationExtractor
      ...
      class Annotation < Struct.new(:line, :tag, :text)
        def self.directories
          @@directories ||= %w(src server plugins frontend config db test)
        end
