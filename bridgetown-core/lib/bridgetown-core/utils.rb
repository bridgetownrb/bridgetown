...
module Bridgetown
  module Utils # rubocop:todo Metrics/ModuleLength
    ...
    def has_yaml_header?(file)
      File.open(file, "rb", &:gets)&.match?(Bridgetown::FrontMatter::Loaders::YAML::HEADER) || false
    end

    def has_rbfm_header?(file)
      File.open(file, "rb", &:gets)&.match?(Bridgetown::FrontMatter::Loaders::Ruby::HEADER) || false
    end
