...
class TestPermalinks < BridgetownFeatureTest
  describe "permalinks" do
    ...
    it "supports custom permalink schema with prefix" do
    ...
    it "supports custom permalink schema with category" do
      create_page "_posts/custom-permalink-schema.md", "Totally custom.", date: "2024-02-27", category: "stuff"
    ...
    it "supports custom permalink schema with date" do
      create_page "_posts/custom-permalink-schema.md", "Totally custom.", date: "2024-02-27", category: "stuff"
    ...
    it "supports per-post permalink ending in slash" do
    ...
    it "supports per-post permalink ending in .html" do
    ...
    it "outputs in lower case even with mixed-case filenames" do
    ...
    it "outputs underscores in filenames" do
    ...
    it "supports multi-lingual rendering with :lang placeholder" do
    ...
    it "supports multi-lingual rendering along with :title placeholder" do
      create_page "_posts/2024-02-27-multi-lingual.es.md", "Impresionante!", title: "Custom Locale"
    ...
    it "does not support multi-lingual rendering if locales aren't configured" do
    ...
    it "supports multi-lingual rendering with multiple locale resources" do
    ...
    it "supports multi-lingual rendering within custom collections" do
    ...
    it "renders a resource with the locale of its front matter key" do
    ...
    it "allows a non-HTML file extension" do
    ...
    it "does not add `_pages` to permalink for resources in _pages" do
