...
class TestFilters < BridgetownUnitTest
  ...
  describe "filters" do
    ...
    describe "where_exp filter" do
      ...
      # FIXME: error at `@filter.where_exp(...)`
      #
      # In Filters::where_exp just before `condition.evaluate(@context)`, there
      # is this difference:
      # - now, with Minitest spec: @context.scopes.first.keys == ["obj"]
      # - previously with Shoulda: @context.scopes.first.keys == ["post"]
      #
      # Test output:
      #   Error:
      ...
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/condition.rb:148:in `rescue in interpret_condition'
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/condition.rb:145:in `interpret_condition'
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/condition.rb:68:in `block in evaluate'
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/condition.rb:67:in `loop'
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/condition.rb:67:in `evaluate'
      ...
      #       /home/runner/work/bridgetown/bridgetown/vendor/bundle/ruby/3.2.0/gems/liquid-5.4.0/lib/liquid/context.rb:134:in `stack'
