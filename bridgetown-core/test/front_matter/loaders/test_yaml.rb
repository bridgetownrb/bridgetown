  ...
  module FrontMatter
    module Loaders
      class TestYaml < BridgetownUnitTest
        describe "The `FrontMatter::Loaders::YAML.header?` method" do
          it "accepts files with YAML front matter" do
          ...
          it "accepts files with extraneous spaces after YAML front matter" do
          ...
          it "rejects pgp files and the like which resemble front matter" do
