Feature: PostUrl Tag
  ...
  Scenario: Site with site-wide custom permalink setting
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "<p><a href=\"/hello-world.html\">Welcome</a></p>" in "output/index.html"
  ...
  Scenario: Site with custom permalink settings on each post
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "<p><a href=\"/2019/hello-world/\">Welcome</a></p>" in "output/index.html"
  ...
  Scenario: Site with a future-dated post
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "<p><a href=\"/we-meet-again.html\">Welcome Again</a></p>" in "output/index.html"
  ...
  Scenario: Site with configured baseurl
    ...
    Then I should get a zero exit status
    And the output directory should exist
    And I should see "<p><a href=\"/blog/2019/02/04/hello-world.html\">Welcome</a></p>" in "output/index.html"
