...
That has now been fixed! Any template engine can render any partial whether ERB, Serbea, or pure Ruby. On top of that, you can now render both partials & components to strings from any context (not just within a template)—including the console! [Read our Edge docs for more information.](https://edge.bridgetownrb.com/docs/template-engines/erb-and-beyond#universal-rendering)
...
We continue to push for awareness of "indie web" and sustainable alternatives to Big Tech solutions. Our documentation now includes [information on how to deploy](https://edge.bridgetownrb.com/docs/deployment#statichosteu) static Bridgetown sites to [statichost.eu](https://statichost.eu), and our Automations feature can load automation scripts from Codeberg and GitLab repositories in addition to GitHub.
