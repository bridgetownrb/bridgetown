...
Besides using a `Hash`, you can also use the handy `front_matter` <abbr title="Domain-Specific Language">DSL</abbr>. Any valid method call made directly in the block will translate to a front matter key. Let's rewrite the above example:
